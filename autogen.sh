...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_srs to login script."
...
# the current dir:
if   test x${GTLANG_srs} = x ; then
	echo "WARNING: The variable \${GTLANG_srs} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_srs} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_srs} has the value:"
	echo "  ${GTLANG_srs}"
