...
This directory contains source files for the Sarsi language morphology
...
In order to compile and use Sarsi language morphology and dictionaries,
you need:
...
The Sarsi language sources can be acquired using [giella SVN
